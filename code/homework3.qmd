...
##a.
My initial thoughts for an affective visualization was to include separate icons for each workout type, organization in a weekly or calendar-like format and then distinguish step count possibly by size of icon. 
